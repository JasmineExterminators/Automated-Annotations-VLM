                        ...
                        if demo.name.endswith(".mp4") and demo.name.startswith("demo_") and demo.name[5:-4].isdigit():
                            ...
                            while True:
                                ...
                                if frame_count % FRAME_GAP == 0:
                                    ...
                                    4. The previous context: {json.dumps([item[0]['summarization'] for item in context])}.
                            ...
                            1. Examine the previous and current frame. Infer what happened between the two frames and what is happening right now. When observing, pay careful attention to the task name, {task.name}. Note object spatial relationships and the robot position. Also, summarize all of the past context, essentially what the robot has done so far, into a short paragraph in the "summarization" area.
                            ...
                            try:
                                ...
                                for item in context:
                                    formatted_data.append(Annotation(
                                        ...
                                        summarization=item[0]["summarization"]
                                    ).model_dump())
